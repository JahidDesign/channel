...
/* ===============================
   MAIN PAGE
=============================== */
export default function PoliticalCards() {
      ...
      <section className="col-span-12 lg:col-span-8">
        ...
        <div className="grid gap-6 sm:grid-cols-2">
          {currentNews.map((item) => (
            ...
            >
              <img
                src={`https://picsum.photos/seed/political-${item.id}/600/400`}
                alt={item.title}
