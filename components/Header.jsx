  ...
  <div className="md:hidden border-t border-gray-200/80 bg-gradient-to-b from-white to-gray-50/50 backdrop-blur-xl animate-[slideDown_0.3s_ease-out]">
    <div className="px-4 py-4 space-y-4">
      ...
      <div className="pt-4 border-t border-gray-200/70">
        <p className="text-xs font-extrabold text-gray-500 uppercase tracking-wider mb-3 px-1">
          Categories
        </p>
            ...
            return (
              <Link
                ...
                className={`px-3 py-2.5 rounded-xl text-xs font-bold text-center transition-all ${
                  active
                    ? 'bg-gradient-to-r from-red-600 via-pink-600 to-red-600 text-white shadow-md'
